...
if (!$con) {
    die(json_encode(array('error' => 'Kết nối CSDL thất bại: ' . mysqli_connect_error())));
}
...
if ($result_get_manv->num_rows > 0) {
    ...
    $sql = "SELECT bangluong.manv, bangluong.hoten, bangluong.songaylam, bangluong.songaynghi, bangluong.songayditre, bangluong.tongluong
            FROM bangluong
            WHERE bangluong.manv = '$ma_nhan_vien' AND bangluong.mabcc = '$mabcc'
            ORDER BY bangluong.mabl DESC LIMIT 1";
    ...
    if ($result->num_rows > 0) {
        ...
        $attendanceData = array('error' => 'Không có dữ liệu chấm công cho nhân viên này.');
    }
} else {
