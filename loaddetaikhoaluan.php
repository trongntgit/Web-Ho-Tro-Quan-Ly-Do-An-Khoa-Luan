...
// Lấy danh sách mã đề tài từ đợt đăng ký
...
// Truy vấn thông tin đề tài và sinh viên, kiểm tra trạng thái và loại đề tài, loại bỏ các đề tài đã có trong bảng phancongkhoaluan
...
$sqlDeTaiSinhVien = "
    ...
    LEFT JOIN phancongkhoaluan ON detai.madetai = phancongkhoaluan.madetai
    WHERE detai.madetai IN ($placeholders) 
      AND detai.trangthai IN ('Đang thực hiện', 'Đã hoàn thành')
      AND detai.loaidetai = 'Khóa luận'
      AND phancongkhoaluan.madetai IS NULL -- Loại bỏ các mã đề tài đã có trong bảng phancongkhoaluan
